      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <MetricCard
            ...
            value={formatStreak(metrics.currentStreak)}
            trend={metrics.currentStreak > 0 ? "profit" : metrics.currentStreak < 0 ? "loss" : "neutral"}
          />
          <MetricCard
            title="Max Losing Streak"
            value={metrics.maxLosingStreak.toString()}
          ...
          <MetricCard
            ...
            trend={metrics.profitFactor >= 1 ? "profit" : "loss"}
          />
        </div>
      </section>
    </div>
